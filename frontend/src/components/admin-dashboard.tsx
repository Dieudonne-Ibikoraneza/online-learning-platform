            ...
            <div className="space-y-6">
                    ...
                    <div className="flex-1">
                      <div className="w-full bg-secondary rounded-full h-2">
                        <div 
                          ...
                          style={{ 
                            width: `${(Number(count) / stats.overview.totalUsers) * 100}%` 
                          }}
                        />
                      </div>
                    </div>
                  </div>
                  <span className="text-sm font-medium">{count as string} users</span>
                </div>
              ))}
              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                ...
                <div className="space-y-2">
                  ...
                  {stats?.courseStats?.byCategory?.slice(0, 3).map((category: any) => (
          ...
          <CardContent>
            ...
            <div className="mt-8">
              ...
              <div className="space-y-3">
                {stats?.recentActivity?.enrollments?.slice(0, 3).map((enrollment: any, index: number) => (
