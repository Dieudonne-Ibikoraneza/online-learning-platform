// components/course-creation-form.tsx
"use client";
...
export function CourseCreationForm() {
    ...
    const onSubmit = async (data: CourseFormValues) => {
        ...
        try {
            ...
            router.push(`/dashboard/courses/${response.data.data._id}/edit`);
        } catch (error) {
        ...
        <div className="max-w-4xl mx-auto p-6">
            <div className="mb-8">
                ...
                <p className="text-muted-foreground mt-2">
                    Fill in the details to create your course. You can add lessons and
                    media later.
                </p>
            </div>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        Make it descriptive and engaging for students
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        Be detailed about what students will achieve
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
